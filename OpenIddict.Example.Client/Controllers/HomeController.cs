...
namespace OpenIddict.Example.Client.Controllers
{
    public sealed class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Index(CancellationToken cancellationToken)
        {
            ...
            var tokenId = await HttpContext.GetTokenAsync(CookieAuthenticationDefaults.AuthenticationScheme, OpenIdConnectParameterNames.IdToken);
